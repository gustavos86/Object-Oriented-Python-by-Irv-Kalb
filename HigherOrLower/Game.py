...
class Game():
    ...
    def __init__(self, window):
        ...
        self.scoreText   = pygwidgets.DisplayText(self.window, (450, 164), f"Score: {self.score}", fontSize=36, textColor=WHITE, justified="right")
        self.messageText = pygwidgets.DisplayText(self.window, (50, 460), '', width=900, justified="center", fontSize=36, textColor=WHITE)
    ...
    def reset(self):  # this method is called when a new round starts
        ...
        self.messageText.setValue(f"Starting card is {self.currentCardName}. Will the next card be higher or lower?")
