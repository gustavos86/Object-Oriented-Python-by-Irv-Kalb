...
while True:
    ...
    pygame.draw.line(window, BLUE, (20, 20), (60, 60), 1)  # right
    pygame.draw.line(window, BLUE, (20, 60), (60, 20), 1)  # bottom

    # Draw a filled circle and an ampty circle
    pygame.draw.circle(window, GREEN, (250, 50), 30, 0)  # filled
    pygame.draw.circle(window, GREEN, (400, 50), 30, 2)  # 2 pixed edge
    ...
    pygame.draw.polygon(window, TEAL, (
        (240, 350),
        (350, 350),
        (410, 410),
        (350, 470),
    ...
    pygame.draw.aaline(window, RED, (500, 400), (540, 470), 10)
    ...
    clock.tick(FRAMES_PER_SECOND)  # make pygame waitDraw a fi